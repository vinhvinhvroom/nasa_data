...
def location(array)
  array.each do |company|
    company.each do |co_name, hash|
      puts "#{co_name}: #{hash["location_1_city"]}, #{hash["location_1_state"]}"
    end
  end
end
puts "2)"
...
def id_number(array)
  array.each do |company|
    company.each do |co_name, hash|
      puts "#{co_name}: #{hash["computed_region_cbhk_fwbd"]}"
    end
  end
end
puts "3)"
...
def type(array)
  array.each do |company|
    company.each do |co_name, hash|
      puts "#{co_name}: #{hash["location_1"]["type"]}"
    end
  end
end
puts "5)"
...
def number(array)
  ...
  puts numbers.sort_by{|key, value| value["computed_region_nnqa_25f4"]}.reverse[0][0]
end
puts "6)"
number(nasa_data)
puts "\n"
...
def gmail(array)
  ...
  array.each do |company|
    company.each do |co_name, hash|
      if hash["email_hosts"].include?("gmail.com")
        count += 1
      end
    end
  end
